...
public class Model extends Observable {
    ...
    public void initBoard()
    {
        ...
        for(int i = 0; i<boardlength; i++){
            board[boardlength-2][i] = new Pawn(2, boardlength-1, i);
        }
        board[boardlength-1][0] = new   Rook(2,0,0);
        board[boardlength-1][1] = new Knight(2,0,1);
        board[boardlength-1][2] = new Bishop(2,0,2);
        board[boardlength-1][3] = new  Queen(2,0,3);
        board[boardlength-1][4] = new   King(2,0,4);
